...
if __name__ == "__main__":
    ...
    # test_path = "./results/jieba_seg_pku.txt"
    # test_path = "./results/pkuseg_seg_pku.txt"
    # test_path = "./results/thu_seg_pku.txt"
    # test_path = "./results/thu_seg_msr.txt"
    # test_path = "./results/jieba_seg_msr.txt"
    test_path = "./results/pkuseg_seg_msr.txt"
